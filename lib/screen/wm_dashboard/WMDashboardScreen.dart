...
import 'package:shree_ram_delivery_app/screen/wm_dashboard/WHHistoryScreen.dart';
import 'package:shree_ram_delivery_app/screen/wm_dashboard/WHHomeScreen.dart';
import 'package:shree_ram_delivery_app/screen/wm_dashboard/WHOrderScreen.dart';
import 'package:shree_ram_delivery_app/screen/wm_dashboard/WHProfileScreen.dart';
import 'package:shree_ram_delivery_app/screen/wm_dashboard/WMDashboaredController.dart';

import '../../support/app_theme.dart';

class WMDashboardScreen extends StatelessWidget {
  const WMDashboardScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return  GetBuilder(
        init: Get.put(WMDashboaredController(context)),
        builder: (controller){
            ...
            body: Column(
              children: [
                Expanded(child: IndexedStack(
                  ...
                  children: [
                    WHHomeScreen.getWHHomeScreen(context, controller),
                    WHOrderScreen.getWHOrderScreen(context, controller),
                    DispatchHistoryScreen.getDispatchHistoryScreen(context, controller),
                    WHProfileScreen.getWHProfileScreen(context, controller)
                  ],
                )),
  ...
  getCustomBottomNavigation(context,WMDashboaredController controller){
    return  Container(
      height: 70,
          ...
          Expanded(
            child: InkWell(
              ...
              onTap:(){
                ...
                controller.getTodaytask(context);
              ...
              child:  Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("Order",style: TextStyle(color: controller.selectedIndex==1?AppColor.secondary:Color(0xff7D7D7D)),)
                  ],
                ),
              ),
            ),
          ...
          Expanded(
            child: InkWell(
              ...
              onTap:(){
                ...
                controller.getHistory(context, Intl().date("yyyy-MM-dd").format(DateTime.now()));
                controller.update();
              },
              child:  Container(
                width: Get.width/4,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("History",style: TextStyle(color: controller.selectedIndex==2?AppColor.secondary:Color(0xff7D7D7D)),)
                  ],
                ),
              ),
            ),
